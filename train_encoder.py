    ...
    def do_epochs(EPOCHS=1000):
        ...
        for epoch_number in range(EPOCHS):
            ...
            if (avg_vloss<0.0016) or epoch_number==EPOCHS-1:
                ...
                model_path = 'models/encoder_model_2obj_nDistr_{}_{}_{}'.format(n_distractors, timestamp, epoch_number)
                torch.save(encoder.state_dict(), model_path)            
                model_path = 'models/decoder_model_2obj_nDistr_{}_{}_{}'.format(n_distractors, timestamp, epoch_number)
